...
class EnrollInfo(db.Model):
    ...
    def __str__(self):
        return "EnrollInfo [id={}, enroll_id={}, backupnum={}, imagepath={}, signatures={}]".format(
            self.id, self.enroll_id, self.backupnum, self.imagepath, self.signatures
        )
    ...
    def selectByBackupnum(self, enroll_id, backupnum):
        ...
        return (
            db.session.query(EnrollInfo)
            .filter_by(enroll_id=enroll_id, backupnum=backupnum)
            .first()
        )
