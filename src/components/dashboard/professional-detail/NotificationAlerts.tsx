      ...
      {isRenewalSoon && (
        <Alert className="border-orange-200 bg-orange-50">
          ...
          <AlertDescription className="text-orange-800">
            <strong>Renovación próxima:</strong> El carnet profesional vence en{" "}
            {daysUntilRenewal} días ({validityDate || "No especificado"})
          </AlertDescription>
        </Alert>
      )}
          ...
          <AlertDescription className="text-blue-800">
            <div className="flex items-center justify-between">
              <span>
                ...
                {notificationCount.total_notificaciones} enviadas
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent>
                  ...
                  <DropdownMenuItem
                    onClick={() => onSendSMS("10_dias_despues")}
                  >
