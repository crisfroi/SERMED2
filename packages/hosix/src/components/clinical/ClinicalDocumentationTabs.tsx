/**
 * HOSIX - Module 16: Clinical Documentation Tabs
...
export const ClinicalDocumentationTabs: React.FC<ClinicalDocumentationTabsProps> = ({
  ...
  return (
    <div className="space-y-6">
              ...
              <div className="space-y-3">
                {documents
                  ...
                  .map((doc) => (
                    <div
                      key={doc.id}
                      className="border border-blue-200 rounded-lg p-4 hover:bg-blue-50 cursor-pointer"
                      onClick={() => setShowModal('view')}
                    >
                      <div className="flex justify-between items-start">
                        <div>
              ...
              <>
                ...
                <div className="flex justify-center gap-2 mt-6">
                  ...
                  <span className="px-3 py-1 text-gray-700">
                    Página {page} de {Math.ceil(totalDocuments / 10)}
                  </span>
                  <button
                    onClick={() =>
                      setPage(Math.min(Math.ceil(totalDocuments / 10), page + 1))
                    }
              ...
              <div className="space-y-3">
                {documents
                  ...
                  .map((doc) => (
                    <div
                      key={doc.id}
                      className="border-2 border-green-400 rounded-lg p-4 bg-green-50 hover:bg-green-100 cursor-pointer"
                      onClick={() => setShowModal('view')}
                    >
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <p className="text-sm text-gray-600 mt-1">
                            Firmado: {new Date(doc.signed_at!).toLocaleString()}
                          </p>
                        </div>
                      </div>
                    </div>
      ...
      {showModal === 'sign' && currentDocument && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      ...
      {showModal === 'view' && currentDocument && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-screen overflow-y-auto">
            <div className="p-6">
              <DocumentViewer
                document={{
                  ...
                  doctorName: 'Dr. Smith', // TODO: Get from relations
                  patientName,
                  createdAt: currentDocument.created_at,
                  signature: currentDocument.signature,
                  signedAt: currentDocument.signed_at,
                }}
