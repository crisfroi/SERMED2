...
export const PatientListTable: React.FC<PatientListTableProps> = ({
  ...
  return (
    <div className="bg-white rounded-lg shadow overflow-hidden">
      ...
      {/* Pagination */}
      {totalPages > 1 && (
        <div className="flex-1 flex items-center justify-between px-6 py-4 border-t border-gray-200">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="px-3 py-1 bg-gray-100 text-gray-700 rounded hover:bg-gray-200 disabled:bg-gray-50 disabled:text-gray-400 text-sm"
            >
              Anterior
            </button>
