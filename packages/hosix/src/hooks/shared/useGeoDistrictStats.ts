...
import { useDistrictStats } from "@hosix/hooks/shared/useAdvancedAnalytics";
import { useDistritosSanitarios, DistritoSanitario } from "@hosix/hooks/shared/useDistritosSanitarios";
