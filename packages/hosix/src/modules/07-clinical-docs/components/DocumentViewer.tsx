/**
 * HOSIX - Module 16: Document Viewer (CLINICAL)
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          {document.signature && document.signedAt && (
            <div className="border-t-2 border-gray-300 pt-4">
              <p className="text-sm text-gray-600">Firmado por: {document.doctorName}</p>
              <p className="text-sm text-gray-600">Fecha: {formatDate(document.signedAt)}</p>
              <p className="text-xs text-gray-500 mt-2">Firma digital: {document.signature.substring(0, 50)}...</p>
            </div>
          )}
        </div>
      </div>
